...
func main() {
	...
	occH := handler.NewOccurrenceHandler(occSvc, groupSvc, userSvc, settingsSvc, commentRepo)
	...
	protected.POST("/duties/:id/description", occH.UpdateDescription)
	...
	protected.POST("/occurrences/:id/description", occH.UpdateDescription)
