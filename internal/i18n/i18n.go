...
var en = map[string]string{
	...
	"settings.tabDuties":                              "Duties",
	"settings.participation":                          "Participation",
	"settings.participationTitle":                     "Participation rules",
	"settings.allowPastParticipation":                 "Allow sign-up and withdraw after a duty starts",
	"settings.allowPastParticipationDesc":             "When disabled, users can only sign up for or withdraw before the scheduled start time.",
	"settings.descriptionEdits":                       "Description Edits",
	"settings.descriptionEditsTitle":                  "Description editing",
	"settings.allowParticipantDescriptionEdit":        "Allow participants to edit duty descriptions",
	"settings.allowParticipantDescriptionEditDesc":    "Admins and organizers can always edit duties.",
	"settings.descriptionEditRequiresParticipant":     "Only signed-up participants can edit descriptions",
	"settings.descriptionEditRequiresParticipantDesc": "When enabled, only participants already signed up for the duty can edit its description.",
	"settings.enableNotifications":                    "Enable email notifications",
	"settings.enableNotificationsDesc":                "Send automatic email digests and reminders when SMTP is configured.",
	...
	"settings.savePanel":                              "Apply changes",
	"settings.savePanelDesc":                          "Changes apply immediately after saving.",
	...
	"flash.pastParticipationDisabled":   "Past duties are closed for sign-up and withdraw.",
	"flash.descriptionUpdated":          "Description updated.",
	...
	"occ.pastParticipationClosed": "Sign-up and withdrawal are closed after the scheduled start time.",
	"occ.pastWithdrawalClosed":    "Withdrawal is closed after the scheduled start time.",
	"occ.noDescription":           "No description.",
	"occ.editDescription":         "Edit description",
	"occ.addDescription":          "Add description",
	"occ.descriptionHelp":         "Up to 5000 characters.",
...
var de = map[string]string{
	...
	"settings.appSettings":                            "Einstellungen",
	"settings.tabEmail":                               "E-Mail",
	"settings.tabDuties":                              "Eins\u00e4tze",
	"settings.participation":                          "Teilnahme",
	"settings.participationTitle":                     "Teilnahmeregeln",
	"settings.allowPastParticipation":                 "Anmelden und Austragen nach Einsatzbeginn erlauben",
	"settings.allowPastParticipationDesc":             "Wenn deaktiviert, k\u00f6nnen Benutzer sich nur vor dem geplanten Beginn anmelden oder austragen.",
	"settings.descriptionEdits":                       "Beschreibungen bearbeiten",
	"settings.descriptionEditsTitle":                  "Beschreibungen bearbeiten",
	"settings.allowParticipantDescriptionEdit":        "Teilnehmern erlauben, Einsatzbeschreibungen zu bearbeiten",
	"settings.allowParticipantDescriptionEditDesc":    "Admins und Organisatoren k\u00f6nnen Eins\u00e4tze immer bearbeiten.",
	"settings.descriptionEditRequiresParticipant":     "Nur eingetragene Teilnehmer k\u00f6nnen Beschreibungen bearbeiten",
	"settings.descriptionEditRequiresParticipantDesc": "Wenn aktiviert, k\u00f6nnen nur bereits eingetragene Teilnehmer die Beschreibung bearbeiten.",
	"settings.enableNotifications":                    "E-Mail-Benachrichtigungen aktivieren",
	"settings.enableNotificationsDesc":                "Automatische E-Mail-\u00dcbersichten und Erinnerungen senden, wenn SMTP konfiguriert ist.",
	...
	"settings.savePanel":                              "\u00c4nderungen anwenden",
	"settings.savePanelDesc":                          "\u00c4nderungen gelten direkt nach dem Speichern.",
	...
	"flash.settingsSaved":               "Einstellungen gespeichert.",
	...
	"flash.pastParticipationDisabled":   "Vergangene Eins\u00e4tze sind f\u00fcr Anmeldung und Austragen geschlossen.",
	"flash.descriptionUpdated":          "Beschreibung aktualisiert.",
	...
	"occ.pastParticipationClosed": "Anmeldung und Austragen sind nach dem geplanten Beginn geschlossen.",
	"occ.pastWithdrawalClosed":    "Austragen ist nach dem geplanten Beginn geschlossen.",
	"occ.noDescription":           "Keine Beschreibung.",
	"occ.editDescription":         "Beschreibung bearbeiten",
	"occ.addDescription":          "Beschreibung hinzuf\u00fcgen",
	"occ.descriptionHelp":         "Bis zu 5000 Zeichen.",
...
var ua = map[string]string{
	...
	"settings.appSettings":                            "Налаштування",
	"settings.tabEmail":                               "Ел. пошта",
	"settings.tabDuties":                              "Заходи",
	"settings.participation":                          "Участь",
	"settings.participationTitle":                     "Правила участі",
	"settings.allowPastParticipation":                 "Дозволити запис і відмову після початку заходу",
	"settings.allowPastParticipationDesc":             "Якщо вимкнено, користувачі можуть записуватися або відмовлятися лише до запланованого початку.",
	"settings.descriptionEdits":                       "Редагування опису",
	"settings.descriptionEditsTitle":                  "Редагування опису",
	"settings.allowParticipantDescriptionEdit":        "Дозволити учасникам редагувати описи заходів",
	"settings.allowParticipantDescriptionEditDesc":    "Адміни й організатори завжди можуть редагувати заходи.",
	"settings.descriptionEditRequiresParticipant":     "Лише записані учасники можуть редагувати описи",
	"settings.descriptionEditRequiresParticipantDesc": "Якщо увімкнено, лише вже записані учасники можуть редагувати опис.",
	"settings.enableNotifications":                    "Увімкнути сповіщення ел. поштою",
	"settings.enableNotificationsDesc":                "Надсилати автоматичні ел. підсумки й нагадування, коли SMTP налаштовано.",
	"settings.emailTitle":                             "Сповіщення ел. поштою",
	...
	"settings.savePanel":                              "Застосувати зміни",
	"settings.savePanelDesc":                          "Зміни застосовуються одразу після збереження.",
	...
	"flash.pastParticipationDisabled":   "Минулі заходи закриті для запису та відмови.",
	"flash.descriptionUpdated":          "Опис оновлено.",
	...
	"occ.pastParticipationClosed": "Запис і відмова закриті після запланованого початку.",
	"occ.pastWithdrawalClosed":    "Відмова закрита після запланованого початку.",
	"occ.noDescription":           "Опису немає.",
	"occ.editDescription":         "Редагувати опис",
	"occ.addDescription":          "Додати опис",
	"occ.descriptionHelp":         "До 5000 символів.",
